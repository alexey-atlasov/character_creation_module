...
def attack(char_name: str, char_class: str) -> str:
    """Функция описывает атаку героя."""
    if char_class == 'warrior':
        string = 'нанёс урон противнику равный'
        return (f'{char_name}'
                f'{string}'
                f'{5 + randint(3, 5)}')
    if char_class == 'mage':
...
def defence(char_name: str, char_class: str) -> str:
    """Функция описывает защиту героя."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает специальные навыки героя."""
    if char_class == 'warrior':
        return (f'{char_name}'
...
def start_training(char_name: str, char_class: str) -> str:
    """Функия описывает каждого персонажа."""
    if char_class == 'warrior':
